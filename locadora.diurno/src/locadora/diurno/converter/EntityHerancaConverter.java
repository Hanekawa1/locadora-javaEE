...
@FacesConverter(value = "entityHerancaConverter", managed = true)
public class EntityHerancaConverter implements Converter<Object> {
    ...
    public Object getAsObject(FacesContext fc, UIComponent component, String string) {
        try {
            ...
            if (type != null) {
                ...
                Field f1 = classe.getSuperclass().getDeclaredField(split[1]);
